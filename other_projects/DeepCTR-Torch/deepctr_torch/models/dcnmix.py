...
class DCNMix(BaseModel):
    ...
    def __init__(self, linear_feature_columns,
                 ...
                 dnn_activation='relu', dnn_use_bn=False, task='binary', device='cpu', gpus=None,adt_config={}):
        ...
        super(DCNMix, self).__init__(linear_feature_columns=linear_feature_columns,
                                     ...
                                     init_std=init_std, seed=seed, task=task, device=device, gpus=gpus,adt_config=adt_config)
